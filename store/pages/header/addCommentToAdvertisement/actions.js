...
export const ADD_COMMENT_TO_ADVERTISEMENT_TEXT =
  "ADD_COMMENT_TO_ADVERTISEMENT_TEXT";
export const ADD_COMMENT_TO_ADVERTISEMENT_BUTTON_SEND =
...
export const sendComment = (
  ...
  return async (dispatch) => {
    try {
      ...
      ws.onmessage = (e) => {
        if (
          e.data.substring(0, 2) == "42" &&
          e.data.substring(4, 11) == "message"
        ) {
