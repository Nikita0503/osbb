export const ACT_OF_RECONCILIATION_CHANGE_FROM_MONTH =
  "ACT_OF_RECONCILIATION_CHANGE_FROM_MONTH";
export const ACT_OF_RECONCILIATION_CHANGE_FROM_YEAR =
  "ACT_OF_RECONCILIATION_CHANGE_FROM_YEAR";
export const ACT_OF_RECONCILIATION_CHANGE_TO_MONTH =
  "ACT_OF_RECONCILIATION_CHANGE_TO_MONTH";
export const ACT_OF_RECONCILIATION_CHANGE_TO_YEAR =
  "ACT_OF_RECONCILIATION_CHANGE_TO_YEAR";
export const ACT_OF_RECONCILIATION_CHANGE_FROM_MONTH_SHOW =
  "ACT_OF_RECONCILIATION_CHANGE_FROM_MONTH_SHOW";
export const ACT_OF_RECONCILIATION_CHANGE_FROM_YEAR_SHOW =
  "ACT_OF_RECONCILIATION_CHANGE_FROM_YEAR_SHOW";
export const ACT_OF_RECONCILIATION_CHANGE_TO_MONTH_SHOW =
  "ACT_OF_RECONCILIATION_CHANGE_TO_MONTH_SHOW";
export const ACT_OF_RECONCILIATION_CHANGE_TO_YEAR_SHOW =
  "ACT_OF_RECONCILIATION_CHANGE_TO_YEAR_SHOW";
export const ACT_OF_RECONCILIATION_CHANGE_SELECTED_DATA =
  "ACT_OF_RECONCILIATION_CHANGE_SELECTED_DATA";
export const ACT_OF_RECONCILIATION_SHOW_LOADING =
