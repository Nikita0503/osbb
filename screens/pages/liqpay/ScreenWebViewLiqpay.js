...
export default class ScreenWebViewLiqpay extends React.Component {
      ...
      <WebView
        ...
        source={{
          html:
            ...
            '"/><input style="width: ' +
            width +
            '; margin-left: 30%; margin-top: 60%" type="image" src="https://static.liqpay.ua/buttons/p1ru.radius.png"/></form>',
        }}
  ...
  render() {
    return (
      <View
        style={{ width: "100%", height: "100%", backgroundColor: "#54687D" }}
      >
        <NavigationEvents
          onDidFocus={() => {
        ...
        >
          ...
          >
            Оплата відобразиться у додатку після її обробки бухгалтером САПО
          </Text>
        </View>
      </View>
    );
