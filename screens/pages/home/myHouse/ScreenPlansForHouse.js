      ...
      >
        ...
        <ScrollView>
          <View style={styles.container}>
            ...
            <View style={styles.container}>
              <View style={{ flexDirection: "row" }}>
                <Text style={styles.dataColumnNameHouseControlCostsStyle}>
                  Назва
                </Text>
                <Text style={styles.dataColumnNameHouseControlCostsStyle}>
                  Вартість
              ...
              <FlatList
                ...
                renderItem={({ item }) => (
                  <ItemHouseControlCosts name={item.name} cost={item.cost} />
                )}
          ...
          <View style={styles.container}>
            ...
            <View style={styles.container}>
              <View style={{ flexDirection: "row" }}>
                <Text style={styles.dataColumnNameHouseMaintenanceCostsStyle}>
                  Назва
                </Text>
                <Text style={styles.dataColumnNameHouseMaintenanceCostsStyle}>
                  Вартість
          ...
          <View style={styles.container}>
            ...
            <View style={styles.container}>
              <View style={{ flexDirection: "row" }}>
                <Text style={styles.dataColumnNameHouseRepairsCostsStyle}>
                  Назва
                </Text>
                <Text style={styles.dataColumnNameHouseRepairsCostsStyle}>
                  Вартість
...
class ItemHouseMaintenanceCosts extends React.Component {
  render() {
    return (
      <View style={{ flexDirection: "row", paddingTop: 5 }}>
        <Text style={styles.itemHouseMaintenanceCostsStyle}>
          {this.props.name}
        </Text>
        <Text style={styles.itemHouseMaintenanceCostsStyle}>
          {this.props.cost}
  ...
  render() {
    return (
      <View style={{ flexDirection: "row", paddingTop: 5 }}>
        ...
        <Text style={styles.itemHouseRepairsCostsStyle}>
          {this.props.amount}
        </Text>
      </View>
    );
