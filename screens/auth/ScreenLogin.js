  ...
  checkToken() {
    if (this.props.authMethod != null) {
      if (this.props.authMethod == AUTH_METHOD_LOGIN) {
        this.props.fetchTokenByEmailPassword(
          this.props.email,
          this.props.password,
      ...
      if (this.props.authMethod == AUTH_METHOD_QRCODE) {
        this.props.signInDevice(
          this.props.tokenDeviceId,
          this.props.navigation
        );
      }
    }
      ...
      <View style={(styles.container, { marginTop: 5 })}>
        <View style={styles.container}>
          ...
          >
            <TextInput
              onChangeText={(text) => {
                this.props.setTokenDeviceId(text);
              }}
          ...
          <View style={{ alignItems: "center", margin: 5 }}>
            <Text style={{ textAlign: "center" }}>
              Або через QR-код у Особистому кабінеті {"\n"}(розділ "Мобільні
              додатки")
            </Text>
          </View>
        </View>
